...
## Fase actual
**v0.3 en desarrollo** (`VERSION=0.3.0-dev`): gateway propio `gd-gateway` en lugar de LiteLLM/Postgres,
multi-nodo y cloud burst. Plan: `docs/prompts/06-v0.3.md`. v0.2.0 publicado (release firmado).
