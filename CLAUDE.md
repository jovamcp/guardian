...
## Fase actual
**v0.4.0 publicado** (2026-09-16; plataforma de referencia Apple Silicon/VM arm64): `guardianctl upgrade` con
...
make doctor        # 20 comprobaciones (root); sondas en gd_agents y gd_audit
